...
constexpr char* jTheta = "theta";
constexpr char* jPhi = "phi";
constexpr char* jRenderMode = "render_mode";
constexpr char* jLatentView = "latent_view";
constexpr char* jLatentDir = "latent_dir";
			...
			{
				{
					...
					sendData[jTheta] = _theta;
					sendData[jPhi] = _phi;
					sendData[jLatentView] = _latent_view;
					sendData[jLatentDir] = _latent_dir;
					sendData[jRenderMode] = _renderMode;
